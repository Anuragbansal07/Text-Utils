...
export default function TextForm(props) {
    ...
    return (
        ...
        <div className = "container" style = {{color : props.mode==="dark" ? "white":"b#080338"}}>
            ...
            <hr></hr>
            <div className="mb-3">
                <textarea className="form-control" value = {text} style={{backgroundColor: props.mode==='dark' ? "grey":"white" , color : props.mode==='dark' ? "white":"#080338"}} onChange={handleOnChange} id="mybox" rows="9"></textarea>
            </div>
